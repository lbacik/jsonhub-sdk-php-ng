...
/**
 * EntityEntityCreate Class Doc Comment
 *
 * @description 
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EntityEntityCreate implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'entity-entity.create';
    ...
    protected static array $openAPITypes = [
        ...
        'data' => 'object',
        'definition' => 'string',
        'parent' => '\OpenAPI\Client\Model\EntityEntityCreate',
        'private' => 'bool'
    ];
    ...
    */
     ...
     * Gets parent
     *
     * @return \OpenAPI\Client\Model\EntityEntityCreate|null
     */
    public function getParent(): ?\OpenAPI\Client\Model\EntityEntityCreate
    {
     ...
     * Sets parent
     *
     * @param \OpenAPI\Client\Model\EntityEntityCreate|null $parent parent
     *
     * @return $this
     */
    public function setParent(?\OpenAPI\Client\Model\EntityEntityCreate $parent): static
    {
        if (is_null($parent)) {
