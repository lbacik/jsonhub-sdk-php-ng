...
/**
 * UserJsonldUserEmpty Class Doc Comment
 *
 ...
 */
class UserJsonldUserEmpty implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'user.jsonld-user.empty';
