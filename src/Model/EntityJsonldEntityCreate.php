...
/**
 * EntityJsonldEntityCreate Class Doc Comment
 *
 * @description 
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EntityJsonldEntityCreate implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'entity.jsonld-entity.create';
    ...
    protected static array $openAPITypes = [
        ...
        'data' => 'object',
        'definition' => 'string',
        'parent' => '\OpenAPI\Client\Model\EntityJsonldEntityCreate',
        'private' => 'bool'
    ];
    ...
    */
     ...
     * Gets parent
     *
     * @return \OpenAPI\Client\Model\EntityJsonldEntityCreate|null
     */
    public function getParent(): ?\OpenAPI\Client\Model\EntityJsonldEntityCreate
    {
     ...
     * Sets parent
     *
     * @param \OpenAPI\Client\Model\EntityJsonldEntityCreate|null $parent parent
     *
     * @return $this
     */
    public function setParent(?\OpenAPI\Client\Model\EntityJsonldEntityCreate $parent): static
    {
        if (is_null($parent)) {
