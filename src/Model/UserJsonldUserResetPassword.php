...
/**
 * UserJsonldUserResetPassword Class Doc Comment
 *
 * @description 
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UserJsonldUserResetPassword implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'user.jsonld-user.reset-password';
