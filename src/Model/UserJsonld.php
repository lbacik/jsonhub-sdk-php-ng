...
class UserJsonld implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'user.jsonld';
    ...
    protected static array $setters = [
        ...
        'token' => 'setToken',
        'reset_password_link' => 'setResetPasswordLink',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('reset_password_link', $data ?? [], null);
    ...
    */
    ...
    public function setOldPassword(?string $old_password): static
    {
        if (is_null($old_password)) {
            array_push($this->openAPINullablesSetToNull, 'old_password');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('old_password', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    /**
     * Gets reset_password_link
     *
     * @return string|null
     */
    public function getResetPasswordLink(): ?string
    {
        return $this->container['reset_password_link'];
    }

    /**
     * Sets reset_password_link
     *
     * @param string|null $reset_password_link reset_password_link
     *
     * @return $this
     */
    public function setResetPasswordLink(?string $reset_password_link): static
    {
        if (is_null($reset_password_link)) {
            array_push($this->openAPINullablesSetToNull, 'reset_password_link');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('reset_password_link', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['reset_password_link'] = $reset_password_link;
     ...
     * Sets activation_url
     *
     * @param string|null $activation_url activation_url
     *
     * @return $this
     */
    public function setActivationUrl(?string $activation_url): static
    {
        if (is_null($activation_url)) {
            array_push($this->openAPINullablesSetToNull, 'activation_url');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('activation_url', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
